...
class GiantBombRequest : public ScraperHttpRequest
{
public:
	GiantBombRequest(std::vector<ScraperSearchResult>& resultsWrite, const std::string& url) : ScraperHttpRequest(resultsWrite, url) {}
protected:
